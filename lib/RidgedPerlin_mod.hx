...
http://www.inear.se/noise2D/ridgednoise.swf

persistance ->  falloff in constructor (I assume)
octaves -> constructor
base_factor -> fill
gain -> fill
offset -> fill
...
class RidgedPerlin {
  ...
  private static var P = [151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53,
      ...
      3,64, 52, 217, 226, 250, 124, 123, 5,202, 38, 147, 118, 126, 255, 82, 85,
      ...
      215, 61, 156, 180, 151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53,
      194, 233, 7,225, 140, 36, 103, 30, 69, 142, 8,99, 37, 240, 21, 10, 23,
      190, 6,148, 247, 120, 234, 75, 0,26, 197, 62, 94, 252, 219, 203, 117, 35,
      11, 32, 57, 177, 33, 88, 237, 149, 56, 87, 174, 20, 125, 136, 171, 168,
      68, 175, 74, 165, 71, 134, 139, 48, 27, 166, 77, 146, 158, 231, 83, 111,
    ...
    for ( py in 0...height )
    {
      ...
      for ( px in 0...width )
      {
        ...
        for ( i in 0...octaves )
        {
			...
			var X = (Std.int(xf) & 255) % width;
			var Y = (Std.int(yf) & 255) % height;
            //var X = (Std.int(xf) & 255) % repeat;
            //var Y = (Std.int(yf) & 255) % repeat;
            ...
            var A  = (p[X]);
            var AA = (p[A+Y]);// + Z;
            var AB = (p[A+((Y+1) % repeat)]);// + Z;

            var B  = (p[(X+1) % repeat]);
            var BA = (p[B+Y]);// + Z;
            var BB = (p[B+((Y+1) % repeat)]);// + Z;
			...
			var hash = (p[(BB+1) % repeat]) & 15;
			var g1 = ((hash&1) == 0 ? (hash<8 ? x1 : y1) : (hash<8 ? -x1 : -y1)) + ((hash&2) == 0 ? hash<4 ? y1 : ( hash==12 ? x1 : z1 ) : hash<4 ? -y1 : ( hash==14 ? -x1 : -z1 ));

			hash = (p[(AB+1) % repeat]) & 15;
			var g2 = ((hash&1) == 0 ? (hash<8 ? x  : y1) : (hash<8 ? -x  : -y1)) + ((hash&2) == 0 ? hash<4 ? y1 : ( hash==12 ? x  : z1 ) : hash<4 ? -y1 : ( hash==14 ? -x : -z1 ));

			hash = (p[(BA+1) % repeat]) & 15;
			var g3 = ((hash&1) == 0 ? (hash<8 ? x1 : y ) : (hash<8 ? -x1 : -y )) + ((hash&2) == 0 ? hash<4 ? y  : ( hash==12 ? x1 : z1 ) : hash<4 ? -y  : ( hash==14 ? -x1 : -z1 ));

			hash = (p[(AA+1) % repeat]) & 15;
